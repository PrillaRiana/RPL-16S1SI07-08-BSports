...
--INSERT OPERATOR
INSERT INTO OPERATOR VALUES ('OP-01','atek','atek','atek29','admin')
INSERT INTO OPERATOR VALUES ('OP-02','prilla','prilla','prilla123','kasir')
INSERT INTO OPERATOR VALUES ('OP-03','akbarmaul','akbar','akbar321','pemilik')
...
INSERT INTO DETAIL_PEMBELIAN VALUES ('PB001','BR001',1,740000)
...
UPDATE BARANG SET QTY  = QTY - @JML WHERE KODE_BARANG = @KB
IF @@error=0
 COMMIT TRANSACTION
ELSE
 ROLLBACK TRANSACTION
...
DECLARE @KB CHAR(5),@JML INT
BEGIN TRANSACTION
SELECT @KB = KODE_BARANG ,@JML = QTY FROM INSERTED
UPDATE BARANG SET STOK = STOK + @JML WHERE KODE_BARANG = @KB
IF @@error=0
 COMMIT TRANSACTION
ELSE
